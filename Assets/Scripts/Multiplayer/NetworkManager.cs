...
// 		PhotonNetwork.JoinRandomRoom(new ExitGames.Client.Photon.Hashtable() { { LEVEL} }, MAX_PLAYERS);
// 		//PhotonNetwork.JoinRandomRoom();
// 	}
...
// 			CustomRoomProperties = new ExitGames.Client.Photon.Hashtable() { { LEVEL} }
// 		});
...
// 	{
// 		Debug.LogError($"Player {PhotonNetwork.LocalPlayer.ActorNumber} joined a room with level: {PhotonNetwork.CurrentRoom.CustomProperties[LEVEL]}");
...
// 	{
// 		PhotonNetwork.LocalPlayer.SetCustomProperties(new ExitGames.Client.Photon.Hashtable() { {LEVEL} });
// 	}
